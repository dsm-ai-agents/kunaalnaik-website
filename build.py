...
<div><h2>Turn AI ambition into operating capability.</h2><p>Training and implementation support for leaders, teams, SMBs, and MSMEs.</p><div class="socials">{social}</div></div>
...
<a class="service-card" href="/ai-agents-for-professionals/"><span class="number">05 / UPSKILL</span><h3>AI agents for professionals</h3><p>Move beyond prompting into outcome design, context engineering, delegation, and verification.</p><span class="arrow">→</span></a>
...
<section class="section section-white"><div class="section-inner"><p class="eyebrow">Point of view</p><p class="quote">“The premium is not knowing more AI tools. It is helping people redesign work, make sound decisions, and keep control as capability scales.”</p></div></section>
...
"corporate-ai-training": {
    ...
    "description": "Role-based corporate AI training that turns AI tools into safe, repeatable workflows for leaders and functional teams.",
    "kicker": "Corporate AI training",
    "h1": "Build AI capability around <em>real work.</em>",
    "lede": "Practical workshops for leadership, operations, marketing, sales, HR, and cross-functional teams—built around business outcomes, role-specific workflows, verification, and responsible adoption.",
    ...
    "outcomes": ["A common language for AI opportunity, limits, and risk", "Role-specific workflows participants can apply immediately", "A repeatable method for briefing, supervising, and checking AI work", "A prioritized 30/60/90-day adoption backlog", "Clear human-approval and data-handling boundaries"],
    "formats": ["Executive AI briefing — strategy, governance, and portfolio decisions", "Role-based workshop — hands-on workflows for one function", "AI workflow lab — teams redesign a live process", "Enablement programme — workshops, office hours, champions, and measurement"],
...
"ai-automation-consulting": {
    ...
    "lede": "A focused consulting path for enterprises, SMBs, and MSMEs that need practical AI adoption without a bloated transformation programme or a pile of disconnected tools.",
...
"ai-agents-for-professionals": {
    "title": "AI Agents for Professionals: From Chat User to AI Operator | Kunaal Naik",
    "description": "Practical AI agent training for professionals: outcomes, context, delegation, verification, skills, and automation.",
    "kicker": "AI agents for professionals",
    "h1": "Stop collecting prompts. Start <em>operating AI.</em>",
    "lede": "A practical learning path for professionals who want to delegate meaningful work to AI agents while keeping judgment, quality, and accountability in human hands.",
    ...
    "outcomes": ["A personal portfolio of bounded AI workflows", "The D4–LOOP method for delegation and supervision", "A reusable context and verification discipline", "A clear boundary between assistance and accountable judgment", "A roadmap from manual use to stable automation"],
    "formats": ["Professional AI fluency workshop", "AI operator cohort for teams", "Personal workflow portfolio sprint", "Leadership-to-operator alignment session"],
    "fit": "Mid-career professionals, managers, consultants, and founders who need working capability rather than another tools overview.",
...
about = f'''{page_hero('About Kunaal Naik', 'From data practitioner to <em>AI operating partner.</em>', 'Kunaal Naik is the founder of Data Science Masterminds, an AI automation coach, trainer, consultant, and TEDx speaker focused on making advanced AI useful in everyday work.', 'About')}<section class="section"><div class="section-inner content-grid"><article class="prose"><h2>A practical point of view</h2><p>Kunaal works at the intersection of data, learning, automation, and business adoption. The through-line is not a particular tool. It is helping people understand complex capability, apply it to meaningful work, and build enough confidence and discipline to use it repeatedly.</p><p>His current focus is AI workflow operating systems: the combination of people, context, tools, approval boundaries, reusable procedures, and measurement that turns AI from an isolated experiment into a working capability.</p><h2>What he teaches</h2><ul><li>How leaders choose valuable, governable AI opportunities</li><li>How teams describe work and supply context precisely</li><li>How professionals delegate bounded tasks and supervise AI agents</li><li>How to verify polished outputs before they become decisions</li><li>How to preserve stable methods as projects, skills, and automations</li></ul><h2>Tools are a means, not the offer</h2><p>Claude Cowork and Hermes Agent are useful wedges because they make multi-step, agentic work tangible. Kunaal also works with AI agents, no-code and low-code automation, n8n, data workflows, and the surrounding operating practices required for responsible adoption.</p><h2>Public profiles</h2><ul><li><a href="https://www.linkedin.com/in/kunaal-naik/">LinkedIn</a></li><li><a href="https://www.youtube.com/KunaalNaik">YouTube</a></li><li><a href="https://www.instagram.com/coachkunaal/">Instagram</a></li><li><a href="https://www.youtube.com/watch?v=JTNNR9uvKPo">TEDxBBAU: The Invisible Work Behind Visible Luck</a></li><li><a href="https://datasciencemasterminds.com/">Data Science Masterminds</a></li></ul><div class="notice">This base profile intentionally excludes unsupported client logos, testimonials, view counts, and performance statistics. Verified evidence will be added as permanent case-study and speaking pages.</div></article>{sidebar('Direct contact', 'For workshops, consulting, partnerships, or speaking enquiries, email Kunaal with the audience and objective.', 'Work with Kunaal')}</div></section>{cta('Need an AI trainer who can also think operationally?', 'Start with the audience, the work they need to improve, and the decision or capability that must exist afterward.', 'Training, consulting or speaking enquiry')}'''
...
cases = f'''{page_hero('Case studies', 'Proof should be <em>inspectable.</em>', 'This library will contain approved, evidence-backed workshop and workflow case studies with context, decisions, implementation details, limitations, and measurable outcomes.', 'Case studies')}<section class="section"><div class="section-inner"><div class="case-empty"><p class="eyebrow">Evidence in preparation</p><h2>No fabricated success stories.</h2><p>The previous website displayed results and testimonials that were not sufficiently substantiated on-page. This new base release removes them rather than carrying uncertain claims forward.</p><p>Each published case study will include the starting workflow, constraints, intervention, human approvals, before/after measures, limitations, and client permission where required.</p><a class="button" href="{mailto('Case study or reference request')}">Request relevant evidence</a></div></div></section>{cta('Have a workflow worth documenting?', 'Kunaal can help define a bounded pilot and an evidence plan before implementation begins.', 'AI workflow pilot enquiry')}'''
