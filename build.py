...
PAGES = {
    ...
    "case-studies/gcc-consulting-firm-claude-cowork-training/index.html": ("Claude Cowork Training Case Study | GCC Consulting Firm", "An anonymized GCC consulting firm training case study covering document processing, parallel reporting, dashboards, SQL, CLAUDE.md memory, and scheduled AI workflows.", "/case-studies/gcc-consulting-firm-claude-cowork-training/", gcc_case, "WebPage"),
